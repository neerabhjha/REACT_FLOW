  ...
  return (
    <div className="group static">
      ...
      <div className="flex flex-row border-2 border-green-500 rounded-md w-[250px] h-[60px] ">
        <MdSystemSecurityUpdateGood className="w-[25%] h-full p-1 bg-blue-50 rounded-md rounded-r-none text-green-500" />
