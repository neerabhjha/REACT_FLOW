...
export const FormNotUpdatedNode = () => {
  return (
    <div className="group static">
      ...
      <div className="flex flex-row border-2 border-gray-400 rounded-md w-[250px] h-[60px] ">
        <MdOutlineSpeakerNotesOff className="w-[25%] h-full p-1 bg-blue-50 rounded-md rounded-r-none text-gray-400" />
        <div className="text-gray-400 flex flex-1 w-full items-center justify-center border-l-2 border-gray-400 bg-white p-1 rounded-md rounded-l-none">
          Form Not Updated By User
        </div>
      </div>
    </div>
  );
